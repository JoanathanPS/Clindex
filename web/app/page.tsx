...
export default function HomePage() {
  return <main className="min-h-screen overflow-hidden bg-canvas text-ink">
    ...
    <header className="relative z-10 mx-auto flex max-w-7xl items-center justify-between px-5 py-5 sm:px-8">
      <Link href="/" aria-label="ClinDex home"><Image src="/clindex-device-hero-mono.png" alt="ClinDex" width={340} height={183} priority className="h-12 w-auto object-contain sm:h-14" /></Link>
